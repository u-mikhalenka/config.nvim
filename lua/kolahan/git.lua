...
cfg.pack_add({
    ...
    setup = function()
        ...
        map({ "<leader>gd", "<cmd>DiffviewOpen<cr>", desc = "Git diff working tree" })
        map({ "<leader>gD", "<cmd>DiffviewOpen HEAD~1..HEAD<cr>", desc = "Git diff last commit" })
        map({ "<leader>gm", "<cmd>DiffviewOpen master<cr>", desc = "Git diff against master" })
        map({ "<leader>gM", "<cmd>DiffviewOpen main<cr>", desc = "Git diff against main" })
        map({ "<leader>gf", "<cmd>DiffviewFileHistory %<cr>", desc = "Git file history" })
        map({ "<leader>gR", "<cmd>DiffviewFileHistory<cr>", desc = "Git repo history" })
        map({ "<leader>gq", "<cmd>DiffviewClose<cr>", desc = "Close diff view" })
    end
})
...
cfg.pack_add({
    ...
    setup = function()
        map({ "<leader>gd", "<cmd>CodeDiff<cr>", desc = "Git diff working tree" })
        map({ "<leader>gD", "<cmd>CodeDiff HEAD~1..HEAD<cr>", desc = "Git diff last commit" })
        map({ "<leader>gm", "<cmd>CodeDiff master<cr>", desc = "Git diff against master" })
        map({ "<leader>gM", "<cmd>CodeDiff main<cr>", desc = "Git diff against main" })
    end
})
