...
cfg.pack_add({
    ...
    keys = {
        ...
        { "<leader>/",  function() Snacks.picker.grep({ cwd = lsp_root(0) }) end,  desc = "Grep (Root Dir)", },
        { "<leader>E",  function() Snacks.explorer() end,                          desc = "File Explorer" },
        { "<leader>ff", function() Snacks.picker.files({ cwd = lsp_root(0) }) end, desc = "Find Files (Root Dir)", },
        ...
        { "<leader>ge", function() Snacks.picker.git_log_file() end,               desc = "Git Log File" },

        -- search
        { "<leader>sg", function() Snacks.picker.grep({ cwd = lsp_root(0) }) end,  desc = "Grep (Root Dir)", },
        ...
        { "<c-/>",      toggle_last_terminal,                                      desc = "Toggle Terminal",          mode = { "n", "t" } },
        { "<A-f>",      toggle_float_terminal,                                     desc = "Toggle Floating Terminal", mode = { "n", "t" } },
        { "<A-1>",      function() toggle_terminal_count(1) end,                   desc = "Toggle Terminal 1",        mode = { "n", "t" } },
        { "<A-2>",      function() toggle_terminal_count(2) end,                   desc = "Toggle Terminal 2",        mode = { "n", "t" } },
        { "<A-3>",      function() toggle_terminal_count(3) end,                   desc = "Toggle Terminal 3",        mode = { "n", "t" } },
        { "<A-4>",      function() toggle_terminal_count(4) end,                   desc = "Toggle Terminal 4",        mode = { "n", "t" } },
        { "<A-5>",      function() toggle_terminal_count(5) end,                   desc = "Toggle Terminal 5",        mode = { "n", "t" } },
        ...
        { "glr",        pick_lsp_references,                                       desc = "References",               nowait = true },
    },
})
